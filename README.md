...
Auras and overheads can be selected and changed via the [Illuminations dashboard](https://doctor4t.ladysnake.org/).
...
Available for free to anyone that registers for an Illuminations account. https://doctor4t.ladysnake.org/pride
...
**Auras are currently only available to donators**, [more information here](https://doctor4t.ladysnake.org/register).
