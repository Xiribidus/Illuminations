...
public class DonateToast implements Toast {
    ...
    public Visibility draw(MatrixStack matrices, ToastManager manager, long startTime) {
        ...
        manager.getClient().textRenderer.draw(matrices, new LiteralText("More info: doctor4t.ladysnake.org/donators").setStyle(Style.EMPTY.withColor(Formatting.GREEN)), 34, 29, -1);
